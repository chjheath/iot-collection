<?php
    ...
    if (!$isOwnerOfCollection && !isset($_POST['submit_form'])) {
        ...
        if (isset($_POST['submit_form'])) {
           Header("Location:delete_item.php?cid=".$_POST['coll_id'].'&item='.$_POST['item_id']);
        }
    }
...
<html>
    ...
    <body>
        <h1>Are you absolutely sure you want to delete this item? This <p style="color:red; font-weight:bold;">CANNOT</p> be reversed.</h1>
        <form action="confirm_delete_item.php" method="post">
